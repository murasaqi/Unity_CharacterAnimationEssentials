...
namespace CharacterAnimationEssentials.Facial
{
    ...
    /// <summary>
    /// http://udasankoubou.blogspot.com/2017/07/unityblendshapeblink.html
    /// 
    /// Edited by : Kodai Takao
    /// </summary>
    public class AutoBlink : MonoBehaviour
    {
        ...
        void OnBlinkClosed()
        {
            ...
            foreach (var shape in blinkShapes)
            {
                shape.skinnedMeshRenderer.SetBlendShapeWeight(shape.index, shape.maxWeight);
            }
